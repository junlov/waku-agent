...
Two tracks exist for the prep work: `tracks/05-queueing-backpressure-ai-engineer.md`
(build the fix) and `tracks/05-queueing-backpressure-architect.md` (decide
the shape of the fix). Pick the one that matches what you are practicing,
or read both, in that order.
